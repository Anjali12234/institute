...
class CourseLivewire extends Component
{
    ...
    public function mount($courseId = null)
    {
        ...
        if ($courseId) {
            ...
            $this->requiredDocuments = [['document_title' => '']]; // Initialize with one empty feature
        }
    }
    ...
    {
        unset($this->requiredDocuments[$index]); // Remove the feature at the given index
        $this->requiredDocuments = array_values($this->requiredDocuments); // Reindex the array to prevent issues
    }
