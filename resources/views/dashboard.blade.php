                        ...
                        <ul class="divide-y divide-slate-200 dark:divide-zink-500">
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="{{ asset('assets/images/avatar-2.png')}}" alt="" class="w-8 h-8 rounded-full">
                                </div>
                                <div class="grow">
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="{{ asset('assets/images/avatar-3.png')}}" alt="" class="w-8 h-8 rounded-full">
                                </div>
                                <div class="grow">
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="{{ asset('assets/images/avatar-4.png')}}" alt="" class="w-8 h-8 rounded-full">
                                </div>
                                <div class="grow">
                            ...
                            <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                                    <img src="{{ asset('assets/images/avatar-5.png')}}" alt="" class="w-8 h-8 rounded-full">
                                </div>
                                <div class="grow">
