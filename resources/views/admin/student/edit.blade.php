...
<img src="{{$student->image}}" height="100" width="100" alt="{{$student->full_name}}">
                            ...
                            <x-input-label : id="qualification" value="{{ old('qualification',$student->qualification) }}" title="Qualification"
                                spanClass="text-red-500" type="text" name="qualification" />
                            
                            <x-input-label : id="how_know" value="{{ old('how_know',$student->how_know) }}" title="how_know"
                                spanClass="text-red-500" type="text" name="how_know" />
                            
                          


                            <x-input-label : id="phone_number" value="{{ old('phone_number',$student->phone_number) }}" title="Phone Number"
                        ...
                        <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                            <x-input-label : id="tole" value="{{ old('tole',$student->tole) }}" title="Tole"
                                ...
                                <x-select id="student_id" value="{{ old('student_id',$student->student_id) }}" title="Reference By"
                                    spanClass="text-white"
                                    selected="{{ old('student_id',$student->student_id) }}"
                                    :students="$students"
                                    name="student_id" />
                                <x-select 
                                id="gender" 
                        ...
                        <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                            ...
                            <x-input-label : id="parent_name" value="{{ old('parent_name',$student->parent_name) }}" title=" Parent Name"
                                spanClass="text-red-500" type="text" name="parent_name" />

                            <x-input-label : id="parent_contact_number" value="{{ old('parent_contact_number',$student->parent_contact_number) }}"
                            ...
                            <x-input-label : id="guardian_contact_number" value="{{ old('guardian_contact_number',$student->guardian_contact_number) }}"
