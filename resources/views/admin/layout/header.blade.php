                ...
                <div
                    ...
                    <a href="{{route('admin.dashboard')}}">
                        ...
                        <span class="group-data-[topbar=dark]:hidden group-data-[topbar=brand]:hidden">
                            <img src="{{ systemSetting()?->logo }}" alt=""
                                class="h-6 mx-auto">
                        </span>
                    </a>
                    <a href="{{route('admin.dashboard')}}"
                ...
                <div class="flex gap-3 ms-auto">
                    <div class="relative flex items-center dropdown h-header">
                        <button type="button"
                            ...
                            <img src="{{ asset('assets/images/us.svg') }}" alt=""
                        ...
                        <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[10rem] flex flex-col gap-4 dark:bg-zink-600"
                            ...
                            <a href="#!" class="flex items-center gap-3 group/items language"
                                ...
                                <img src="{{ asset('assets/images/es.svg') }}" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                                    class="transition-all duration-200 ease-linear font-15medium text- text-slate-600 dark:text-zink-200 group-hover/items:text-custom-500">
                                    Spanish</h6>
                            ...
                            <a href="#!" class="flex items-center gap-3 group/items language"
                                ...
                                <img src="{{ asset('assets/images/de.svg') }}" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                                    class="transition-all duration-200 ease-linear font-15medium text- text-slate-600 dark:text-zink-200 group-hover/items:text-custom-500">
                                    German</h6>
                            ...
                            <a href="#!" class="flex items-center gap-3 group/items language"
                                ...
                                <img src="{{ asset('assets/images/fr.svg') }}" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                                    class="transition-all duration-200 ease-linear font-15medium text- text-slate-600 dark:text-zink-200 group-hover/items:text-custom-500">
                                    French</h6>
                            ...
                            <a href="#!" class="flex items-center gap-3 group/items language"
                                ...
                                <img src="{{ asset('assets/images/jp.svg') }}" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                                    class="transition-all duration-200 ease-linear font-15medium text- text-slate-600 dark:text-zink-200 group-hover/items:text-custom-500">
                                    Japanese</h6>
                            ...
                            <a href="#!" class="flex items-center gap-3 group/items language"
                                ...
                                <img src="{{ asset('assets/images/china.svg') }}" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                                    class="transition-all duration-200 ease-linear font-15medium text- text-slate-600 dark:text-zink-200 group-hover/items:text-custom-500">
                                    Chinese</h6>
                            ...
                            <a href="#!" class="flex items-center gap-3 group/items language"
                                ...
                                <img src="{{ asset('assets/images/it2.svg') }}" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                                    class="transition-all duration-200 ease-linear font-15medium text- text-slate-600 dark:text-zink-200 group-hover/items:text-custom-500">
                                    Italian</h6>
                            ...
                            <a href="#!" class="flex items-center gap-3 group/items language"
                                ...
                                <img src="{{ asset('assets/images/ru2.svg') }}" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                                    class="transition-all duration-200 ease-linear font-15medium text- text-slate-600 dark:text-zink-200 group-hover/items:text-custom-500">
                                    Russian</h6>
                            ...
                            <a href="#!" class="flex items-center gap-3 group/items language"
                                ...
                                <img src="{{ asset('assets/images/ae2.svg') }}" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                                    class="transition-all duration-200 ease-linear font-15medium text- text-slate-600 dark:text-zink-200 group-hover/items:text-custom-500">
                                    Arabic</h6>
                                    ...
                                    <a href="#!"
                                        ...
                                        <div class="grow">
                                            ...
                                            <p class="mb-0 text-sm text-slate-500 dark:text-zink-300"><i
                                                    data-lucide="clock"
                                                    class="inline-block w-3.5 h-3.5 mr-1"></i> <span
                                                    class="align-middle">Wednesday 03:42 PM</span></p>
                                        </div>
                                        <div
                                    ...
                                    <a href="#!"
                                        ...
                                        <div class="w-10 h-10 bg-yellow-100 rounded-md shrink-0">
                                            <img src="{{ Auth::user()->image }}"
                                                alt="{{Auth::user()->name}}" class="rounded-md">
                                        </div>
                                        <div class="grow">
                                    ...
                                    <a href="#!"
                                        ...
                                        <div class="grow">
                                            ...
                                            <p class="mb-0 text-sm text-slate-500 dark:text-zink-300"><i
                                                    data-lucide="clock"
                                                    class="inline-block w-3.5 h-3.5 mr-1"></i> <span
                                                    class="align-middle">Thursday 06:59 AM</span></p>
                                        </div>
                                        <div
                                            class="flex items-center self-start gap-2 text-xs text-slate-500 shrink-0 dark:text-zink-300">
                            ...
                            <ul>
                                <li>
                                    <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                        href="{{route('admin.user.profilePage')}}"><i data-lucide="user-2"
                                    ...
                                    <form method="POST" action="{{ route('admin.user.logout') }}">
                                        ...
                                        <button
                                            ...
                                            href="auth-logout-basic.html"><i data-lucide="log-out"
                                                class="inline-block size-4 ltr:mr-2 rtl:ml-2"></i> Sign Out</button>
                                    </form>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="flex flex-col gap-4">
                <div class="flex gap-2 product">
                    <div
                        ...
                        <img src="{{ asset('assets/images/img-012.png') }}" alt=""
                            class="h-8">
                    </div>
