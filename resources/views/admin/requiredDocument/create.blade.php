        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <x-input-error />
                    <form action="{{route('admin.requiredDocument.store')}}" method="Post" enctype="multipart/form-data">
                        @csrf
                        <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                            <div class="mb-4">
                                ...
                                <input type="text" id="title" name="title"
                                    ...
                                    placeholder="Enter the title of the Document" value="{{ old('title') }}" required>
                            </div>
