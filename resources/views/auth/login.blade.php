                ...
                <form action="{{ route('login') }}" method="POST" class="mt-10" >
                    @csrf
                        ...
                        <div class="mt-10 text-center">
                            <p class="mb-0 text-slate-500 dark:text-zink-200">Don't have an account ? <a href="auth-signup-cover.html" class="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500"> SignUp</a> </p>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="shrink-0">
                            <div class="relative dropdown text-end">
                                <button type="button" class="inline-flex items-center gap-3 transition-all duration-200 ease-linear dropdown-toggle btn border-slate-200 dark:border-zink-400/60 group/items focus:border-custom-500 dark:focus:border-custom-500" id="dropdownMenuButton" data-bs-toggle="dropdown">
                                    <img src="{{asset('assets/images/us2.svg')}}" alt="" class="object-cover h-5 rounded-full">
                                ...
                                <div class="absolute z-50 hidden p-3 mt-1 text-left list-none bg-white rounded-md shadow-md dropdown-menu min-w-[9rem] flex flex-col gap-3 dark:bg-zink-600" aria-labelledby="dropdownMenuButton">
                                    <a href="#!" class="flex items-center gap-3 group/items">
                                        <img src="{{asset('assets/images/us2.svg')}}" alt="" class="object-cover h-4 rounded-full">
                                    ...
                                    <a href="#!" class="flex items-center gap-3 group/items">
                                        <img src="{{asset('assets/images/es2.svg')}}" alt="" class="object-cover h-4 rounded-full">
                                    ...
                                    <a href="#!" class="flex items-center gap-3 group/items">
                                        <img src="{{asset('assets/images/de2.svg')}}" alt="" class="object-cover h-4 rounded-full">
                                    ...
                                    <a href="#!" class="flex items-center gap-3 group/items">
                                        <img src="{{asset('assets/images/fr2.svg')}}" alt="" class="object-cover h-4 rounded-full">
                                    ...
                                    <a href="#!" class="flex items-center gap-3 group/items">
                                        <img src="{{asset('assets/images/jp2.svg')}}" alt="" class="object-cover h-4 rounded-full">
                                    ...
                                    <a href="#!" class="flex items-center gap-3 group/items">
                                        <img src="{{asset('assets/images/it.svg')}}" alt="" class="object-cover h-4 rounded-full">
                                    ...
                                    <a href="#!" class="flex items-center gap-3 group/items">
                                        <img src="{{asset('assets/images/ru.svg')}}" alt="" class="object-cover h-4 rounded-full">
                                    ...
                                    <a href="#!" class="flex items-center gap-3 group/items">
                                        <img src="{{asset('assets/images/ae.svg')}}" alt="" class="object-cover h-4 rounded-full">
